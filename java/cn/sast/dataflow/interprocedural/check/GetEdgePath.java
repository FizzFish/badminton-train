...
public final class GetEdgePath extends IPath {
    ...
    public /* synthetic */ GetEdgePath(Unit node, IValue heapObject, IPath heapObjectPath, Object mt, Object key, IValue value, IPath valuePath, Object info, DefaultConstructorMarker $constructor_marker) {
    ...
    private GetEdgePath(Unit node, IValue heapObject, IPath heapObjectPath, Object mt, Object key, IValue value, IPath valuePath, Object info) {
        super(null);
        this.node = node;
    ...
    /* compiled from: PathCompanion.kt */
    @Metadata(mv = {2, PointsToGraphKt.pathStrictMod, PointsToGraphKt.pathStrictMod}, k = PseudoTopologicalOrderer.REVERSE, xi = 48, d1 = {"��0\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0003\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018��2\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003JX\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\n\u0010\b\u001a\u00060\tj\u0002`\n2\u0006\u0010\u000b\u001a\u00020\f2\n\u0010\r\u001a\u00060\u0001j\u0002`\u000e2\b\u0010\u000f\u001a\u0004\u0018\u00010\u00012\n\u0010\u0004\u001a\u00060\tj\u0002`\n2\u0006\u0010\u0010\u001a\u00020\f2\n\b\u0002\u0010\u0011\u001a\u0004\u0018\u00010\u0001¨\u0006\u0012"}, d2 = {"Lcn/sast/dataflow/interprocedural/check/GetEdgePath$Companion;", "", "<init>", "()V", "v", "Lcn/sast/dataflow/interprocedural/check/GetEdgePath;", "env", "Lcn/sast/dataflow/interprocedural/analysis/HeapValuesEnv;", "heapObject", "Lcn/sast/dataflow/interprocedural/analysis/IValue;", "Lcn/sast/dataflow/interprocedural/analysis/V;", "heapObjectPath", "Lcn/sast/dataflow/interprocedural/check/IPath;", "mt", "Lcn/sast/dataflow/interprocedural/check/ModelT;", "key", "value", "info", "corax-data-flow"})
    /* loaded from: GetEdgePath$Companion.class */
    public static final class Companion {
        ...
        public static /* synthetic */ GetEdgePath v$default(Companion companion, HeapValuesEnv heapValuesEnv, IValue iValue, IPath iPath, Object obj, Object obj2, IValue iValue2, IPath iPath2, Object obj3, int i, Object obj4) {
            if ((i & 128) != 0) {
                obj3 = null;
            }
        ...
        @NotNull
        public final GetEdgePath v(@NotNull HeapValuesEnv env, @NotNull IValue heapObject, @NotNull IPath heapObjectPath, @NotNull Object mt, @Nullable Object key, @NotNull IValue v, @NotNull IPath value, @Nullable Object info) {
            ...
            return (GetEdgePath) IPath.Companion.getInterner(new GetEdgePath(env.getNode(), heapObject, heapObjectPath, mt, key, v, value, info, null));
        }
    }
    ...
    public boolean equivTo(@Nullable Object other) {
        ...
        return (other instanceof GetEdgePath) && equivHashCode() == ((GetEdgePath) other).equivHashCode() && getNode() == ((GetEdgePath) other).getNode() && Intrinsics.areEqual(this.heapObject, ((GetEdgePath) other).heapObject) && this.heapObjectPath == ((GetEdgePath) other).heapObjectPath && Intrinsics.areEqual(this.mt, ((GetEdgePath) other).mt) && Intrinsics.areEqual(this.key, ((GetEdgePath) other).key) && Intrinsics.areEqual(this.value, ((GetEdgePath) other).value) && this.valuePath == ((GetEdgePath) other).valuePath && Intrinsics.areEqual(this.info, ((GetEdgePath) other).info);
    }
