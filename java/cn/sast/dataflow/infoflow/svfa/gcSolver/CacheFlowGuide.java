...
public final class CacheFlowGuide {
    ...
    private final LoadingCache<UnitGraph, ILocalDFA> cache = this.flowCacheBuilder.build(new CacheLoader<UnitGraph, ILocalDFA>() { // from class: cn.sast.dataflow.infoflow.svfa.gcSolver.CacheFlowGuide$cache$1
