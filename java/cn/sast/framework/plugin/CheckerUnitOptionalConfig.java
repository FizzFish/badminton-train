...
/* loaded from: CheckerUnitOptionalConfig.class */
public final class CheckerUnitOptionalConfig extends ConfigSerializable implements IOptional, IFieldOptions {
    ...
    public static /* synthetic */ CheckerUnitOptionalConfig copy$default(CheckerUnitOptionalConfig checkerUnitOptionalConfig, String str, boolean z, SAOptions sAOptions, int i, Object obj) {
        if ((i & 1) != 0) {
            str = checkerUnitOptionalConfig.name;
        }
        if ((i & 2) != 0) {
            z = checkerUnitOptionalConfig.enable;
        }
        if ((i & 4) != 0) {
            sAOptions = checkerUnitOptionalConfig.options;
        }
        return checkerUnitOptionalConfig.copy(str, z, sAOptions);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.name, checkerUnitOptionalConfig.name) && this.enable == checkerUnitOptionalConfig.enable && Intrinsics.areEqual(this.options, checkerUnitOptionalConfig.options);
    }

    /* compiled from: SAConfiguration.kt */
    @Metadata(mv = {2, PointsToGraphKt.pathStrictMod, PointsToGraphKt.pathStrictMod}, k = PseudoTopologicalOrderer.REVERSE, xi = 48, d1 = {"��\u0016\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\b\u0086\u0003\u0018��2\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcn/sast/framework/plugin/CheckerUnitOptionalConfig$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcn/sast/framework/plugin/CheckerUnitOptionalConfig;", "corax-framework"})
    /* loaded from: CheckerUnitOptionalConfig$Companion.class */
    public static final class Companion {
        ...
        @NotNull
        public final KSerializer<CheckerUnitOptionalConfig> serializer() {
            return CheckerUnitOptionalConfig$$serializer.INSTANCE;
        }
    }
    ...
    public /* synthetic */ CheckerUnitOptionalConfig(int seen0, String name, boolean enable, SAOptions options, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if (7 != (7 & seen0)) {
            PluginExceptionsKt.throwMissingFieldException(seen0, 7, CheckerUnitOptionalConfig$$serializer.INSTANCE.getDescriptor());
        }
        this.name = name;
        this.enable = enable;
    ...
    public int compareTo(@NotNull ConfigSerializable other) {
        ...
        if (getEnable() != ((CheckerUnitOptionalConfig) other).getEnable()) {
