...
/* loaded from: IUTBotResultCollector.class */
public interface IUTBotResultCollector extends IResultCollector {
    void addUtState();

    /* compiled from: ResultCollector.kt */
    @Metadata(mv = {2, PointsToGraphKt.pathStrictMod, PointsToGraphKt.pathStrictMod}, k = 3, xi = 48)
    /* loaded from: IUTBotResultCollector$DefaultImpls.class */
    public static final class DefaultImpls {
        @Nullable
        public static Object flush(@NotNull IUTBotResultCollector $this, @NotNull Continuation<? super Unit> continuation) {
