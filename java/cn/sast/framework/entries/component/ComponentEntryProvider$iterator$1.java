...
@DebugMetadata(f = "ComponentEntryProvider.kt", l = {50}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "cn.sast.framework.entries.component.ComponentEntryProvider$iterator$1")
/* loaded from: ComponentEntryProvider$iterator$1.class */
final class ComponentEntryProvider$iterator$1 extends SuspendLambda implements Function2<FlowCollector<? super IEntryPointProvider.AnalyzeTask>, Continuation<? super Unit>, Object> {
    int label;
    private /* synthetic */ Object L$0;
    final /* synthetic */ ComponentEntryProvider this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ComponentEntryProvider$iterator$1(ComponentEntryProvider $receiver, Continuation<? super ComponentEntryProvider$iterator$1> continuation) {
        super(2, continuation);
        this.this$0 = $receiver;
    }

    public final Continuation<Unit> create(Object value, Continuation<?> continuation) {
        Continuation<Unit> componentEntryProvider$iterator$1 = new ComponentEntryProvider$iterator$1(this.this$0, continuation);
        componentEntryProvider$iterator$1.L$0 = value;
        return componentEntryProvider$iterator$1;
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case PointsToGraphKt.pathStrictMod /* 0 */:
                ...
                this.label = 1;
                if ($this$flow.emit(new IEntryPointProvider.AnalyzeTask(this.this$0) { // from class: cn.sast.framework.entries.component.ComponentEntryProvider$iterator$1.1
