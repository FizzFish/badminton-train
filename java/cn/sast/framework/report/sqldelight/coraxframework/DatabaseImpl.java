...
/* loaded from: DatabaseImpl.class */
final class DatabaseImpl extends TransacterImpl implements Database {
    ...
    @Override // cn.sast.framework.report.sqldelight.Database
    @NotNull
    ...
    public static final class Schema implements SqlSchema<QueryResult.Value<Unit>> {
        ...
        public /* bridge */ /* synthetic */ QueryResult create(SqlDriver driver) {
            return QueryResult.Value.box-impl(m436create0iQ1z0(driver));
        }

        public /* bridge */ /* synthetic */ QueryResult migrate(SqlDriver driver, long oldVersion, long newVersion, AfterVersion[] callbacks) {
            return QueryResult.Value.box-impl(m437migratezeHU3Mk(driver, oldVersion, newVersion, callbacks));
        }
