...
/* loaded from: Verify_macro.class */
public final class Verify_macro {
    ...
    public static /* synthetic */ Verify_macro copy$default(Verify_macro verify_macro, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = verify_macro.id;
        }
        if ((i & 2) != 0) {
            j2 = verify_macro.__macro_note_set_hash_id;
        }
        return verify_macro.copy(j, j2);
    }

    @NotNull
    public String toString() {
        long j = this.id;
        long j2 = this.__macro_note_set_hash_id;
        return "Verify_macro(id=" + j + ", __macro_note_set_hash_id=" + j + ")";
    }

    public int hashCode() {
        int result = Long.hashCode(this.id);
        return (result * 31) + Long.hashCode(this.__macro_note_set_hash_id);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.id == verify_macro.id && this.__macro_note_set_hash_id == verify_macro.__macro_note_set_hash_id;
    }
