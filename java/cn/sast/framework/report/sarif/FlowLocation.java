...
/* loaded from: FlowLocation.class */
public final class FlowLocation {
    ...
    public static /* synthetic */ FlowLocation copy$default(FlowLocation flowLocation, Message message, PhysicalLocation physicalLocation, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public int hashCode() {
        ...
        return (result * 31) + this.physicalLocation.hashCode();
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.message, flowLocation.message) && Intrinsics.areEqual(this.physicalLocation, flowLocation.physicalLocation);
    }

    /* compiled from: SarifLog.kt */
    @Metadata(mv = {2, PointsToGraphKt.pathStrictMod, PointsToGraphKt.pathStrictMod}, k = PseudoTopologicalOrderer.REVERSE, xi = 48, d1 = {"��\u0016\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\b\u0086\u0003\u0018��2\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcn/sast/framework/report/sarif/FlowLocation$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcn/sast/framework/report/sarif/FlowLocation;", "corax-framework"})
    /* loaded from: FlowLocation$Companion.class */
    public static final class Companion {
        ...
        @NotNull
        public final KSerializer<FlowLocation> serializer() {
            return FlowLocation$$serializer.INSTANCE;
        }
    }
    ...
    public static final /* synthetic */ void write$Self$corax_framework(FlowLocation self, CompositeEncoder output, SerialDescriptor serialDesc) {
        output.encodeSerializableElement(serialDesc, 0, Message$$serializer.INSTANCE, self.message);
        output.encodeSerializableElement(serialDesc, 1, PhysicalLocation$$serializer.INSTANCE, self.physicalLocation);
    }
    ...
    public /* synthetic */ FlowLocation(int seen0, Message message, PhysicalLocation physicalLocation, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (3 & seen0)) {
            PluginExceptionsKt.throwMissingFieldException(seen0, 3, FlowLocation$$serializer.INSTANCE.getDescriptor());
        }
