...
internal class `ForwardInterProceduralAnalysis$doAnalyze$jobs$1$1$invokeSuspend$lambda$2$$inlined$bracket$5` : Function0<Object> {
   fun `ForwardInterProceduralAnalysis$doAnalyze$jobs$1$1$invokeSuspend$lambda$2$$inlined$bracket$5`(
      `$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef, var4: Any
   ) {
