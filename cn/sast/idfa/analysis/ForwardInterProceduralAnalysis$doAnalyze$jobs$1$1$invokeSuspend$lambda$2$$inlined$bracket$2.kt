...
internal class `ForwardInterProceduralAnalysis$doAnalyze$jobs$1$1$invokeSuspend$lambda$2$$inlined$bracket$2` : Function0<Object> {
   fun `ForwardInterProceduralAnalysis$doAnalyze$jobs$1$1$invokeSuspend$lambda$2$$inlined$bracket$2`(
