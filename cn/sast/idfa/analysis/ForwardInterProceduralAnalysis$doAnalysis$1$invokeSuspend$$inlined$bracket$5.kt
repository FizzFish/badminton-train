...
internal class `ForwardInterProceduralAnalysis$doAnalysis$1$invokeSuspend$$inlined$bracket$5` : Function0<Object> {
   fun `ForwardInterProceduralAnalysis$doAnalysis$1$invokeSuspend$$inlined$bracket$5`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
