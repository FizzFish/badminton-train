...
internal class `SootCtx$onAfterCallGraphConstruction$$inlined$bracket$default$2` : Function0<Object> {
   fun `SootCtx$onAfterCallGraphConstruction$$inlined$bracket$default$2`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
