...
internal class `SootCtx$loadClasses$$inlined$bracket$default$4` : Function0<Object> {
   fun `SootCtx$loadClasses$$inlined$bracket$default$4`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$t`: java.lang.Throwable) {
