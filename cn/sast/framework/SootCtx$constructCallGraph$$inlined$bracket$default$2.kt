...
internal class `SootCtx$constructCallGraph$$inlined$bracket$default$2` : Function0<Object> {
   fun `SootCtx$constructCallGraph$$inlined$bracket$default$2`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
