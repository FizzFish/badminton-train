...
internal class `SootCtx$loadClasses$$inlined$bracket$default$2` : Function0<Object> {
   fun `SootCtx$loadClasses$$inlined$bracket$default$2`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
