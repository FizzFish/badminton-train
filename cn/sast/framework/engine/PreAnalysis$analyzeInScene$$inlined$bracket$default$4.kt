...
internal class `PreAnalysis$analyzeInScene$$inlined$bracket$default$4` : Function0<Object> {
   fun `PreAnalysis$analyzeInScene$$inlined$bracket$default$4`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$t`: java.lang.Throwable) {
