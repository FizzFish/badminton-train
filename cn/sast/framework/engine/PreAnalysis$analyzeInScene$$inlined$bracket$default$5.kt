...
internal class `PreAnalysis$analyzeInScene$$inlined$bracket$default$5` : Function0<Object> {
   fun `PreAnalysis$analyzeInScene$$inlined$bracket$default$5`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
