...
internal class `PreAnalysis$analyzeInScene$$inlined$bracket$default$2` : Function0<Object> {
   fun `PreAnalysis$analyzeInScene$$inlined$bracket$default$2`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
