...
internal class `SootCtx$loadClasses$$inlined$bracket$default$5` : Function0<Object> {
   fun `SootCtx$loadClasses$$inlined$bracket$default$5`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
