...
internal class `SootUtils$dex2jar$lambda$2$$inlined$bracket$default$4` : Function0<Object> {
   fun `SootUtils$dex2jar$lambda$2$$inlined$bracket$default$4`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$t`: java.lang.Throwable) {
