...
internal class `SootUtils$dex2jar$lambda$2$$inlined$bracket$default$5` : Function0<Object> {
   fun `SootUtils$dex2jar$lambda$2$$inlined$bracket$default$5`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
