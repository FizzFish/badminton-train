...
internal class StaticMethodDecl0<R>(base: ISMethodDecl<Any>, argumentCnt: Int = 0) : ISMethodDecl0<R>, ISMethodDecl<R> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl0.CheckBuilder<Any> {
      return new ISMethodDecl0.CheckBuilder<R>(this, config) {
         private final ISMethodDecl0<R> method;

         {
            this.$$delegate_0 = StaticMethodDecl0.access$getBase$p(`$receiver`).checkBuilder(`$config`);
   ...
   override fun model(config: (MethodConfig?) -> Unit, block: (ISMethodDecl0CheckBuilder<R>?) -> Unit): ISMethodDecl0<R> {
      return ISMethodDecl0.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl0CheckBuilder<R>?) -> Unit): ISMethodDecl0<R> {
      return ISMethodDecl0.DefaultImpls.modelNoArg(this, config, block);
   }
