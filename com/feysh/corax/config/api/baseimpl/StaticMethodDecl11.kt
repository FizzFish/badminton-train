...
internal class StaticMethodDecl11<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>(base: ISMethodDecl<Any>, argumentCnt: Int = 11) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl11.CheckBuilder<Any, Any, Any, Any, Any, Any, Any, Any, Any, Any, Any, Any> {
      return new ISMethodDecl11.CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>(this, config) {
         private final ISMethodDecl11<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> method;

         {
            this.$$delegate_0 = StaticMethodDecl11.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP5(this);
         }

         @Override
         public IParameterT<P6> getP6() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP6(this);
         }

         @Override
         public IParameterT<P7> getP7() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP7(this);
         }

         @Override
         public IParameterT<P8> getP8() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP8(this);
         }

         @Override
         public IParameterT<P9> getP9() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP9(this);
         }

         @Override
         public IParameterT<P10> getP10() {
            return ISMethodDecl11.CheckBuilder.DefaultImpls.getP10(this);
         }
   ...
   override fun model(
      ...
      return ISMethodDecl11.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl11CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>?) -> Unit): ISMethodDecl11<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> {
      return ISMethodDecl11.DefaultImpls.modelNoArg(this, config, block);
   }
