...
public class RawMethodDecl(delegate: IMethodDecl<Any>) : IRawMethodDecl<Object>, IMethodDecl<Object> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IRawMethodDecl.CheckBuilder<Any> {
      return new RawMethodDecl.CheckBuilder(this.delegate.checkBuilder(config));
   }
   ...
   override fun model(config: (MethodConfig?) -> Unit, block: (IRawMethodDeclCheckBuilder<Object>?, Array<IParameterT<Object>>?) -> Unit): IRawMethodDecl<Object> {
      return IRawMethodDecl.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IRawMethodDeclCheckBuilder<Object>?) -> Unit): IRawMethodDecl<Object> {
      return IRawMethodDecl.DefaultImpls.modelNoArg(this, config, block);
   }
   ...
   public class CheckBuilder(delegate: com.feysh.corax.config.api.IMethodDecl.CheckBuilder<Any>) :
      IRawMethodDecl.CheckBuilder<Object>,
      IMethodDecl.CheckBuilder<Object> {
      private final val delegate: com.feysh.corax.config.api.IMethodDecl.CheckBuilder<Any>
      ...
      override fun getThis(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getThis(this);
      }

      override fun getP0(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP0(this);
      }

      override fun getP1(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP1(this);
      }

      override fun getP2(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP2(this);
      }

      override fun getP3(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP3(this);
      }

      override fun getP4(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP4(this);
      }

      override fun getP5(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP5(this);
      }

      override fun getP6(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP6(this);
      }

      override fun getP7(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP7(this);
      }

      override fun getP8(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP8(this);
      }

      override fun getP9(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP9(this);
      }

      override fun getP10(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP10(this);
      }

      override fun getP11(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP11(this);
      }

      override fun getP12(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP12(this);
      }

      override fun getP13(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP13(this);
      }

      override fun getP14(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP14(this);
      }

      override fun getP15(): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.getP15(this);
      }

      override fun parameter(index: Int): IParameterT<Object> {
         return IRawMethodDecl.CheckBuilder.DefaultImpls.parameter(this, index);
      }
