...
internal class InstanceMethodDecl6<R, This, P0, P1, P2, P3, P4, P5>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 6) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl6.CheckBuilder<Any, Any, Any, Any, Any, Any, Any, Any> {
      return new IIMethodDecl6.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5>(this, config) {
         private final IIMethodDecl6<R, This, P0, P1, P2, P3, P4, P5> method;

         {
            this.$$delegate_0 = InstanceMethodDecl6.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl6.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl6.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return IIMethodDecl6.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return IIMethodDecl6.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return IIMethodDecl6.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return IIMethodDecl6.CheckBuilder.DefaultImpls.getP5(this);
         }
   ...
   override fun model(
      ...
      return IIMethodDecl6.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl6CheckBuilder<R, This, P0, P1, P2, P3, P4, P5>?) -> Unit): IIMethodDecl6<R, This, P0, P1, P2, P3, P4, P5> {
      return IIMethodDecl6.DefaultImpls.modelNoArg(this, config, block);
   }
