...
internal class InstanceMethodDecl4<R, This, P0, P1, P2, P3>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 4) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl4.CheckBuilder<Any, Any, Any, Any, Any, Any> {
      return new IIMethodDecl4.CheckBuilder<R, This, P0, P1, P2, P3>(this, config) {
         private final IIMethodDecl4<R, This, P0, P1, P2, P3> method;

         {
            this.$$delegate_0 = InstanceMethodDecl4.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl4.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl4.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return IIMethodDecl4.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return IIMethodDecl4.CheckBuilder.DefaultImpls.getP3(this);
         }
   ...
   override fun model(
      ...
      return IIMethodDecl4.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl4CheckBuilder<R, This, P0, P1, P2, P3>?) -> Unit): IIMethodDecl4<R, This, P0, P1, P2, P3> {
      return IIMethodDecl4.DefaultImpls.modelNoArg(this, config, block);
   }
