...
internal class StaticMethodDecl6<R, P0, P1, P2, P3, P4, P5>(base: ISMethodDecl<Any>, argumentCnt: Int = 6) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl6.CheckBuilder<Any, Any, Any, Any, Any, Any, Any> {
      return new ISMethodDecl6.CheckBuilder<R, P0, P1, P2, P3, P4, P5>(this, config) {
         private final ISMethodDecl6<R, P0, P1, P2, P3, P4, P5> method;

         {
            this.$$delegate_0 = StaticMethodDecl6.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return ISMethodDecl6.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return ISMethodDecl6.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return ISMethodDecl6.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return ISMethodDecl6.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return ISMethodDecl6.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return ISMethodDecl6.CheckBuilder.DefaultImpls.getP5(this);
         }
   ...
   override fun model(
      ...
      return ISMethodDecl6.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl6CheckBuilder<R, P0, P1, P2, P3, P4, P5>?) -> Unit): ISMethodDecl6<R, P0, P1, P2, P3, P4, P5> {
      return ISMethodDecl6.DefaultImpls.modelNoArg(this, config, block);
   }
