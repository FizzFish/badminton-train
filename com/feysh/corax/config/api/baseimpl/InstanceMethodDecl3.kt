...
internal class InstanceMethodDecl3<R, This, P0, P1, P2>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 3) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl3.CheckBuilder<Any, Any, Any, Any, Any> {
      return new IIMethodDecl3.CheckBuilder<R, This, P0, P1, P2>(this, config) {
         private final IIMethodDecl3<R, This, P0, P1, P2> method;

         {
            this.$$delegate_0 = InstanceMethodDecl3.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl3.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl3.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return IIMethodDecl3.CheckBuilder.DefaultImpls.getP2(this);
         }
   ...
   override fun model(
      config: (MethodConfig?) -> Unit, block: (IIMethodDecl3CheckBuilder<R, This, P0, P1, P2>?, IParameterT<P0>?, IParameterT<P1>?, IParameterT<P2>?) -> Unit
   ): IIMethodDecl3<R, This, P0, P1, P2> {
      return IIMethodDecl3.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl3CheckBuilder<R, This, P0, P1, P2>?) -> Unit): IIMethodDecl3<R, This, P0, P1, P2> {
      return IIMethodDecl3.DefaultImpls.modelNoArg(this, config, block);
   }
