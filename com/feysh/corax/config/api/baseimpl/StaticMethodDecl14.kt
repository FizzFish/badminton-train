...
internal class StaticMethodDecl14<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>(base: ISMethodDecl<Any>, argumentCnt: Int = 14) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl14.CheckBuilder<
         Any,
         Any,
         Any,
         Any,
         ...
         Any
      > {
      return new ISMethodDecl14.CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>(this, config) {
         private final ISMethodDecl14<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> method;

         {
            this.$$delegate_0 = StaticMethodDecl14.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP5(this);
         }

         @Override
         public IParameterT<P6> getP6() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP6(this);
         }

         @Override
         public IParameterT<P7> getP7() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP7(this);
         }

         @Override
         public IParameterT<P8> getP8() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP8(this);
         }

         @Override
         public IParameterT<P9> getP9() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP9(this);
         }

         @Override
         public IParameterT<P10> getP10() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP10(this);
         }

         @Override
         public IParameterT<P11> getP11() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP11(this);
         }

         @Override
         public IParameterT<P12> getP12() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP12(this);
         }

         @Override
         public IParameterT<P13> getP13() {
            return ISMethodDecl14.CheckBuilder.DefaultImpls.getP13(this);
         }
   ...
   override fun model(
      ...
      return ISMethodDecl14.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(
      config: (MethodConfig?) -> Unit, block: (ISMethodDecl14CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>?) -> Unit
   ): ISMethodDecl14<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> {
      return ISMethodDecl14.DefaultImpls.modelNoArg(this, config, block);
   }
