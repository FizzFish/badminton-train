...
internal class InstanceMethodDecl2<R, This, P0, P1>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 2) : IIMethodDecl2<R, This, P0, P1>, IIMethodDecl<R, This> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl2.CheckBuilder<Any, Any, Any, Any> {
      return new IIMethodDecl2.CheckBuilder<R, This, P0, P1>(this, config) {
         private final IIMethodDecl2<R, This, P0, P1> method;

         {
            this.$$delegate_0 = InstanceMethodDecl2.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl2.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl2.CheckBuilder.DefaultImpls.getP1(this);
         }
   ...
   override fun model(config: (MethodConfig?) -> Unit, block: (IIMethodDecl2CheckBuilder<R, This, P0, P1>?, IParameterT<P0>?, IParameterT<P1>?) -> Unit): IIMethodDecl2<R, This, P0, P1> {
      return IIMethodDecl2.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl2CheckBuilder<R, This, P0, P1>?) -> Unit): IIMethodDecl2<R, This, P0, P1> {
      return IIMethodDecl2.DefaultImpls.modelNoArg(this, config, block);
   }
