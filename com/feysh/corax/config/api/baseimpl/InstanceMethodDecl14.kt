...
internal class InstanceMethodDecl14<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 14) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl14.CheckBuilder<
         Any,
         Any,
         Any,
         Any,
         ...
         Any
      > {
      return new IIMethodDecl14.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>(this, config) {
         private final IIMethodDecl14<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> method;

         {
            this.$$delegate_0 = InstanceMethodDecl14.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP5(this);
         }

         @Override
         public IParameterT<P6> getP6() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP6(this);
         }

         @Override
         public IParameterT<P7> getP7() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP7(this);
         }

         @Override
         public IParameterT<P8> getP8() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP8(this);
         }

         @Override
         public IParameterT<P9> getP9() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP9(this);
         }

         @Override
         public IParameterT<P10> getP10() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP10(this);
         }

         @Override
         public IParameterT<P11> getP11() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP11(this);
         }

         @Override
         public IParameterT<P12> getP12() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP12(this);
         }

         @Override
         public IParameterT<P13> getP13() {
            return IIMethodDecl14.CheckBuilder.DefaultImpls.getP13(this);
         }
   ...
   override fun model(
      ...
      return IIMethodDecl14.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(
      config: (MethodConfig?) -> Unit, block: (IIMethodDecl14CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>?) -> Unit
   ): IIMethodDecl14<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> {
      return IIMethodDecl14.DefaultImpls.modelNoArg(this, config, block);
   }
