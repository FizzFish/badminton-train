...
internal class InstanceMethodDecl7<R, This, P0, P1, P2, P3, P4, P5, P6>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 7) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl7.CheckBuilder<Any, Any, Any, Any, Any, Any, Any, Any, Any> {
      return new IIMethodDecl7.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6>(this, config) {
         private final IIMethodDecl7<R, This, P0, P1, P2, P3, P4, P5, P6> method;

         {
            this.$$delegate_0 = InstanceMethodDecl7.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl7.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl7.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return IIMethodDecl7.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return IIMethodDecl7.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return IIMethodDecl7.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return IIMethodDecl7.CheckBuilder.DefaultImpls.getP5(this);
         }

         @Override
         public IParameterT<P6> getP6() {
            return IIMethodDecl7.CheckBuilder.DefaultImpls.getP6(this);
         }
   ...
   override fun model(
      ...
      return IIMethodDecl7.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl7CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6>?) -> Unit): IIMethodDecl7<R, This, P0, P1, P2, P3, P4, P5, P6> {
      return IIMethodDecl7.DefaultImpls.modelNoArg(this, config, block);
   }
