...
internal class InstanceMethodDecl5<R, This, P0, P1, P2, P3, P4>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 5) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl5.CheckBuilder<Any, Any, Any, Any, Any, Any, Any> {
      return new IIMethodDecl5.CheckBuilder<R, This, P0, P1, P2, P3, P4>(this, config) {
         private final IIMethodDecl5<R, This, P0, P1, P2, P3, P4> method;

         {
            this.$$delegate_0 = InstanceMethodDecl5.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl5.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl5.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return IIMethodDecl5.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return IIMethodDecl5.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return IIMethodDecl5.CheckBuilder.DefaultImpls.getP4(this);
         }
   ...
   override fun model(
      ...
      return IIMethodDecl5.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl5CheckBuilder<R, This, P0, P1, P2, P3, P4>?) -> Unit): IIMethodDecl5<R, This, P0, P1, P2, P3, P4> {
      return IIMethodDecl5.DefaultImpls.modelNoArg(this, config, block);
   }
