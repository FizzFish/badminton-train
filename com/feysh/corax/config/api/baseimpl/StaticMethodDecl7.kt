...
internal class StaticMethodDecl7<R, P0, P1, P2, P3, P4, P5, P6>(base: ISMethodDecl<Any>, argumentCnt: Int = 7) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl7.CheckBuilder<Any, Any, Any, Any, Any, Any, Any, Any> {
   ...
   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl7CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6>?) -> Unit): ISMethodDecl7<R, P0, P1, P2, P3, P4, P5, P6> {
