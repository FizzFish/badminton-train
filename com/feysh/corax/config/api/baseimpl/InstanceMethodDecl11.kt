...
internal class InstanceMethodDecl11<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 11) :
   IIMethodDecl11<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>,
   IIMethodDecl<R, This> {
   private final val base: IIMethodDecl<Any, Any>
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl11.CheckBuilder<
         Any,
         Any,
         Any,
         Any,
         ...
         Any
      > {
      return new IIMethodDecl11.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>(this, config) {
         private final IIMethodDecl11<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> method;

         {
            this.$$delegate_0 = InstanceMethodDecl11.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP5(this);
         }

         @Override
         public IParameterT<P6> getP6() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP6(this);
         }

         @Override
         public IParameterT<P7> getP7() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP7(this);
         }

         @Override
         public IParameterT<P8> getP8() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP8(this);
         }

         @Override
         public IParameterT<P9> getP9() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP9(this);
         }

         @Override
         public IParameterT<P10> getP10() {
            return IIMethodDecl11.CheckBuilder.DefaultImpls.getP10(this);
         }
   ...
   override fun model(
      ...
      return IIMethodDecl11.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl11CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>?) -> Unit): IIMethodDecl11<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> {
      return IIMethodDecl11.DefaultImpls.modelNoArg(this, config, block);
   }
