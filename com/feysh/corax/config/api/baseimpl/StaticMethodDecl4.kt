...
internal class StaticMethodDecl4<R, P0, P1, P2, P3>(base: ISMethodDecl<Any>, argumentCnt: Int = 4) : ISMethodDecl4<R, P0, P1, P2, P3>, ISMethodDecl<R> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl4.CheckBuilder<Any, Any, Any, Any, Any> {
      return new ISMethodDecl4.CheckBuilder<R, P0, P1, P2, P3>(this, config) {
         private final ISMethodDecl4<R, P0, P1, P2, P3> method;

         {
            this.$$delegate_0 = StaticMethodDecl4.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return ISMethodDecl4.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return ISMethodDecl4.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return ISMethodDecl4.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return ISMethodDecl4.CheckBuilder.DefaultImpls.getP3(this);
         }
   ...
   override fun model(
      ...
      return ISMethodDecl4.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl4CheckBuilder<R, P0, P1, P2, P3>?) -> Unit): ISMethodDecl4<R, P0, P1, P2, P3> {
      return ISMethodDecl4.DefaultImpls.modelNoArg(this, config, block);
   }
