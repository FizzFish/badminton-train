...
internal class StaticMethodDecl5<R, P0, P1, P2, P3, P4>(base: ISMethodDecl<Any>, argumentCnt: Int = 5) : ISMethodDecl5<R, P0, P1, P2, P3, P4>, ISMethodDecl<R> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl5.CheckBuilder<Any, Any, Any, Any, Any, Any> {
      return new ISMethodDecl5.CheckBuilder<R, P0, P1, P2, P3, P4>(this, config) {
         private final ISMethodDecl5<R, P0, P1, P2, P3, P4> method;

         {
            this.$$delegate_0 = StaticMethodDecl5.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return ISMethodDecl5.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return ISMethodDecl5.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return ISMethodDecl5.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return ISMethodDecl5.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return ISMethodDecl5.CheckBuilder.DefaultImpls.getP4(this);
         }
   ...
   override fun model(
      ...
      return ISMethodDecl5.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl5CheckBuilder<R, P0, P1, P2, P3, P4>?) -> Unit): ISMethodDecl5<R, P0, P1, P2, P3, P4> {
      return ISMethodDecl5.DefaultImpls.modelNoArg(this, config, block);
   }
