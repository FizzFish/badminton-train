...
internal class StaticMethodDecl2<R, P0, P1>(base: ISMethodDecl<Any>, argumentCnt: Int = 2) : ISMethodDecl2<R, P0, P1>, ISMethodDecl<R> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl2.CheckBuilder<Any, Any, Any> {
      return new ISMethodDecl2.CheckBuilder<R, P0, P1>(this, config) {
         private final ISMethodDecl2<R, P0, P1> method;

         {
            this.$$delegate_0 = StaticMethodDecl2.access$getBase$p(`$receiver`).checkBuilder(`$config`);
   ...
   override fun model(config: (MethodConfig?) -> Unit, block: (ISMethodDecl2CheckBuilder<R, P0, P1>?, IParameterT<P0>?, IParameterT<P1>?) -> Unit): ISMethodDecl2<R, P0, P1> {
      return ISMethodDecl2.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl2CheckBuilder<R, P0, P1>?) -> Unit): ISMethodDecl2<R, P0, P1> {
