...
internal class InstanceMethodDecl0<R, This>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 0) : IIMethodDecl0<R, This>, IIMethodDecl<R, This> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl0.CheckBuilder<Any, Any> {
      return new IIMethodDecl0.CheckBuilder<R, This>(this, config) {
         private final IIMethodDecl0<R, This> method;

         {
            this.$$delegate_0 = InstanceMethodDecl0.access$getBase$p(`$receiver`).checkBuilder(`$config`);
   ...
   override fun model(config: (MethodConfig?) -> Unit, block: (IIMethodDecl0CheckBuilder<R, This>?) -> Unit): IIMethodDecl0<R, This> {
      return IIMethodDecl0.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl0CheckBuilder<R, This>?) -> Unit): IIMethodDecl0<R, This> {
      return IIMethodDecl0.DefaultImpls.modelNoArg(this, config, block);
   }
