...
internal class InstanceMethodDecl9<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 9) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl9.CheckBuilder<Any, Any, Any, Any, Any, Any, Any, Any, Any, Any, Any> {
      return new IIMethodDecl9.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8>(this, config) {
         private final IIMethodDecl9<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8> method;

         {
            this.$$delegate_0 = InstanceMethodDecl9.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl9.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl9.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return IIMethodDecl9.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return IIMethodDecl9.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return IIMethodDecl9.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return IIMethodDecl9.CheckBuilder.DefaultImpls.getP5(this);
         }

         @Override
         public IParameterT<P6> getP6() {
            return IIMethodDecl9.CheckBuilder.DefaultImpls.getP6(this);
         }

         @Override
         public IParameterT<P7> getP7() {
            return IIMethodDecl9.CheckBuilder.DefaultImpls.getP7(this);
         }

         @Override
         public IParameterT<P8> getP8() {
            return IIMethodDecl9.CheckBuilder.DefaultImpls.getP8(this);
         }
   ...
   override fun model(
      ...
      return IIMethodDecl9.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl9CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8>?) -> Unit): IIMethodDecl9<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8> {
      return IIMethodDecl9.DefaultImpls.modelNoArg(this, config, block);
   }
