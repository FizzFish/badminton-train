...
internal class StaticMethodDecl3<R, P0, P1, P2>(base: ISMethodDecl<Any>, argumentCnt: Int = 3) : ISMethodDecl3<R, P0, P1, P2>, ISMethodDecl<R> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl3.CheckBuilder<Any, Any, Any, Any> {
      return new ISMethodDecl3.CheckBuilder<R, P0, P1, P2>(this, config) {
         private final ISMethodDecl3<R, P0, P1, P2> method;

         {
            this.$$delegate_0 = StaticMethodDecl3.access$getBase$p(`$receiver`).checkBuilder(`$config`);
   ...
   override fun model(
      config: (MethodConfig?) -> Unit, block: (ISMethodDecl3CheckBuilder<R, P0, P1, P2>?, IParameterT<P0>?, IParameterT<P1>?, IParameterT<P2>?) -> Unit
   ): ISMethodDecl3<R, P0, P1, P2> {
      return ISMethodDecl3.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl3CheckBuilder<R, P0, P1, P2>?) -> Unit): ISMethodDecl3<R, P0, P1, P2> {
