...
internal class StaticMethodDecl8<R, P0, P1, P2, P3, P4, P5, P6, P7>(base: ISMethodDecl<Any>, argumentCnt: Int = 8) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl8.CheckBuilder<Any, Any, Any, Any, Any, Any, Any, Any, Any> {
      return new ISMethodDecl8.CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7>(this, config) {
         private final ISMethodDecl8<R, P0, P1, P2, P3, P4, P5, P6, P7> method;

         {
            this.$$delegate_0 = StaticMethodDecl8.access$getBase$p(`$receiver`).checkBuilder(`$config`);
            this.method = `$receiver`;
         }

         @Override
         public ISMethodDecl8<R, P0, P1, P2, P3, P4, P5, P6, P7> getMethod() {
            return this.method;
         }

         @Override
         public IParameterT<P0> getP0() {
            return ISMethodDecl8.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return ISMethodDecl8.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return ISMethodDecl8.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return ISMethodDecl8.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return ISMethodDecl8.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return ISMethodDecl8.CheckBuilder.DefaultImpls.getP5(this);
         }

         @Override
         public IParameterT<P6> getP6() {
            return ISMethodDecl8.CheckBuilder.DefaultImpls.getP6(this);
         }

         @Override
         public IParameterT<P7> getP7() {
            return ISMethodDecl8.CheckBuilder.DefaultImpls.getP7(this);
         }
   ...
   override fun model(
      ...
      return ISMethodDecl8.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl8CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7>?) -> Unit): ISMethodDecl8<R, P0, P1, P2, P3, P4, P5, P6, P7> {
      return ISMethodDecl8.DefaultImpls.modelNoArg(this, config, block);
   }
