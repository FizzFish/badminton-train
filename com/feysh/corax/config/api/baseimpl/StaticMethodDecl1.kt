...
internal class StaticMethodDecl1<R, P0>(base: ISMethodDecl<Any>, argumentCnt: Int = 1) : ISMethodDecl1<R, P0>, ISMethodDecl<R> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): ISMethodDecl1.CheckBuilder<Any, Any> {
      return new ISMethodDecl1.CheckBuilder<R, P0>(this, config) {
         private final ISMethodDecl1<R, P0> method;

         {
            this.$$delegate_0 = StaticMethodDecl1.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return ISMethodDecl1.CheckBuilder.DefaultImpls.getP0(this);
         }
   ...
   override fun model(config: (MethodConfig?) -> Unit, block: (ISMethodDecl1CheckBuilder<R, P0>?, IParameterT<P0>?) -> Unit): ISMethodDecl1<R, P0> {
      return ISMethodDecl1.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (ISMethodDecl1CheckBuilder<R, P0>?) -> Unit): ISMethodDecl1<R, P0> {
      return ISMethodDecl1.DefaultImpls.modelNoArg(this, config, block);
   }
