...
internal class InstanceMethodDecl8<R, This, P0, P1, P2, P3, P4, P5, P6, P7>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 8) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl8.CheckBuilder<Any, Any, Any, Any, Any, Any, Any, Any, Any, Any> {
   ...
   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl8CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7>?) -> Unit): IIMethodDecl8<R, This, P0, P1, P2, P3, P4, P5, P6, P7> {
