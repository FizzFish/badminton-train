...
internal class InstanceMethodDecl10<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 10) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl10.CheckBuilder<Any, Any, Any, Any, Any, Any, Any, Any, Any, Any, Any, Any> {
      return new IIMethodDecl10.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9>(this, config) {
         private final IIMethodDecl10<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9> method;

         {
            this.$$delegate_0 = InstanceMethodDecl10.access$getBase$p(`$receiver`).checkBuilder(`$config`);
            this.method = `$receiver`;
         }

         @Override
         public IIMethodDecl10<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9> getMethod() {
            return this.method;
         }

         @Override
         public IParameterT<P0> getP0() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP0(this);
         }

         @Override
         public IParameterT<P1> getP1() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP1(this);
         }

         @Override
         public IParameterT<P2> getP2() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP5(this);
         }

         @Override
         public IParameterT<P6> getP6() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP6(this);
         }

         @Override
         public IParameterT<P7> getP7() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP7(this);
         }

         @Override
         public IParameterT<P8> getP8() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP8(this);
         }

         @Override
         public IParameterT<P9> getP9() {
            return IIMethodDecl10.CheckBuilder.DefaultImpls.getP9(this);
         }
   ...
   override fun model(
      ...
      return IIMethodDecl10.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl10CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9>?) -> Unit): IIMethodDecl10<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9> {
      return IIMethodDecl10.DefaultImpls.modelNoArg(this, config, block);
   }
