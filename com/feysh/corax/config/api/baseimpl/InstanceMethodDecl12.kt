...
internal class InstanceMethodDecl12<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 12) :
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl12.CheckBuilder<
         Any,
         Any,
         Any,
         Any,
         ...
         Any
      > {
      return new IIMethodDecl12.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11>(this, config) {
         private final IIMethodDecl12<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> method;

         {
            this.$$delegate_0 = InstanceMethodDecl12.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P2> getP2() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP2(this);
         }

         @Override
         public IParameterT<P3> getP3() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP3(this);
         }

         @Override
         public IParameterT<P4> getP4() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP4(this);
         }

         @Override
         public IParameterT<P5> getP5() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP5(this);
         }

         @Override
         public IParameterT<P6> getP6() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP6(this);
         }

         @Override
         public IParameterT<P7> getP7() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP7(this);
         }

         @Override
         public IParameterT<P8> getP8() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP8(this);
         }

         @Override
         public IParameterT<P9> getP9() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP9(this);
         }

         @Override
         public IParameterT<P10> getP10() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP10(this);
         }

         @Override
         public IParameterT<P11> getP11() {
            return IIMethodDecl12.CheckBuilder.DefaultImpls.getP11(this);
         }
   ...
   override fun model(
      ...
      return IIMethodDecl12.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(
      config: (MethodConfig?) -> Unit, block: (IIMethodDecl12CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11>?) -> Unit
   ): IIMethodDecl12<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> {
      return IIMethodDecl12.DefaultImpls.modelNoArg(this, config, block);
   }
