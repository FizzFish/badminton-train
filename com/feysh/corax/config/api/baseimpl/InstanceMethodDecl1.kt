...
internal class InstanceMethodDecl1<R, This, P0>(base: IIMethodDecl<Any, Any>, argumentCnt: Int = 1) : IIMethodDecl1<R, This, P0>, IIMethodDecl<R, This> {
   ...
   public override fun checkBuilder(config: (MethodConfig) -> Unit): IIMethodDecl1.CheckBuilder<Any, Any, Any> {
      return new IIMethodDecl1.CheckBuilder<R, This, P0>(this, config) {
         private final IIMethodDecl1<R, This, P0> method;

         {
            this.$$delegate_0 = InstanceMethodDecl1.access$getBase$p(`$receiver`).checkBuilder(`$config`);
         ...
         public IParameterT<P0> getP0() {
            return IIMethodDecl1.CheckBuilder.DefaultImpls.getP0(this);
         }
   ...
   override fun model(config: (MethodConfig?) -> Unit, block: (IIMethodDecl1CheckBuilder<R, This, P0>?, IParameterT<P0>?) -> Unit): IIMethodDecl1<R, This, P0> {
      return IIMethodDecl1.DefaultImpls.model(this, config, block);
   }

   override fun modelNoArg(config: (MethodConfig?) -> Unit, block: (IIMethodDecl1CheckBuilder<R, This, P0>?) -> Unit): IIMethodDecl1<R, This, P0> {
      return IIMethodDecl1.DefaultImpls.modelNoArg(this, config, block);
   }
